...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        self.transactions = self.transactions + [Transaction(self.transaction_index,self.balance-amount,self.balance)]
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions = self.transactions + [Transaction(self.transaction_index,self.balance,self.balance)]
            self.transaction_index = self.transaction_index + 1
